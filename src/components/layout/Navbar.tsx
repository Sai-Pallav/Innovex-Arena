        ...
        <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center justify-between gap-8">
                      ...
                      >
                        <div className="rounded-[16px] bg-[#0a0118]/95 backdrop-blur-xl border border-white/10 shadow-[inset_0_0_24px_rgba(255,255,255,0.04)] overflow-hidden">
                          <div className="p-2 space-y-1">
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-medium text-[#f4f0ff] group-hover/item:text-[#b7a4fb] transition-colors">
                                  Live Online Classes
                                </div>
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-medium text-[#f4f0ff] group-hover/item:text-[#9382ff] transition-colors">
                                  Campus Programs
                                </div>
                                <p className="text-xs text-[#918ea0] mt-0.5 leading-relaxed">
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-medium text-[#f4f0ff] group-hover/item:text-[#8562ff] transition-colors">
                                  Hybrid Cohorts
                                </div>
                                <p className="text-xs text-[#918ea0] mt-0.5 leading-relaxed">
                          ...
                          <div className="border-t border-white/5 p-3">
                            <Link
                              to="/classes"
                              className="flex items-center justify-between text-xs font-medium text-[#b7a4fb] hover:text-[#f4f0ff] transition-colors group/more"
                            >
            ...
            <div className="hidden lg:flex items-center gap-3 shrink-0">
              ...
              <Link to="/contact">
                <span className="px-5 py-2 rounded-full bg-white text-[#040112] font-medium text-xs sm:text-sm hover:bg-zinc-100 transition-all duration-200 flex items-center gap-1.5 shadow-[0_0_20px_rgba(255,255,255,0.18)] hover:shadow-[0_0_28px_rgba(255,255,255,0.30)] group">
