...
async function main() {
  ...
  const outDir = 'C:\\Users\\kotas\\.gemini\\antigravity-ide\\brain\\881f5a55-c18d-4763-8432-18865208a10f';
  ...
  // 2. 3/4 FRONT VIEW (matching panel 1 of reference image)
  ...
  // 3. OUTER SIDE VIEW (matching panel 3 of reference image)
  ...
  // 4. INNER SIDE VIEW (looking from chest outward through shoulder gap)
  await shoot(`${prefix}_inner_side.png`, ((rPos) => ({
    cx: rPos.x - 0.28,
    cy: rPos.y - 0.06,
    cz: rPos.z + 0.15,
    lx: rPos.x,
  ...
  // 5. BACK VIEW (matching panel 4 of reference image)
  ...
  // 6. BOTH SHOULDERS FRONT OVERVIEW (to verify left/right symmetry per prompt item 15)
